...
North America seems to have a very high amount of plastic waste per capita, and Oceania is one of the continents with the least. 
...
We define the 'color' and 'fill' so the aesthetics are directly relating to the variable. The alpah level is the characteristics of the plotting geom because it is a setting we want applied to the entire graph. 
...
Violin plots show the density and the shape of the distribution which box plots don't. Box plots can help show outliers. 
...
The relationship between the plastic waste per capita and mismanaged plastic waste per capita shows that the ratio between the two is almost the same. 
...
There does seem to be some clear distinctions between continents. 
